# Heartbeat — Backend Engineer (API & Services)
...
As API & Services engineer, your work focuses on **routes, services, and middleware**:

1. **Read the task** — understand requirements, parent context, and constraints.
2. **Read the code** — understand existing routes and service patterns before changing anything.
3. **Implement** — write clean, secure, well-typed TypeScript. Follow existing codebase patterns.
4. **Test** — write tests for new endpoints. Cover happy path, auth failures, and invalid input.
